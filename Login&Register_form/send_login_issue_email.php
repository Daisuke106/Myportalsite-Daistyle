<?php
// send_login_issue_email.php

// require '..\..\..\vendor\autoload.php';
// use PHPMailer\PHPMailer\PHPMailer;
// use PHPMailer\PHPMailer\Exception;

// function sendLoginIssueEmail($email, $username, $app_password) {
//     mb_language('uni');
...
//         $subject = '【重要】Daistyleログインに関するお知らせ';
//         $body =  "$toname 様\n"
//                 ."Daistyleをご利用いただきありがとうございます。" . "\n"
//                 ."\n"
//                 . "お知らせです。" . "\n"
//                 . "あなたのアカウントはセキュリティのために一時的にロックされています。" . "\n"
//                 . "パスワードを5回連続で誤入力されたため、アカウントがロックされました。" . "\n"
//                 ."\n"
