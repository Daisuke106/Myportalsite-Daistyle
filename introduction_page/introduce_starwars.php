...
<head>
    <meta charset="UTF-8">
  <title>Introducing Daistyle Star Wars opening</title>
...
<article class="starwars">
  ...
  <section class="start">
    <p>
      Start <br> <span>Welcome to Daistyle!!</span> <br> from 2023
      <br> Daistyleの機能について
      <span>Remake by Tim Pietrusky and Daisuke Yamaguchi</span>
    </p>
  </section>
  ...
  <section class="intro">
    A long time ago, in a galaxy far,<br> Loading features....
  </section>
  ...
  <section class="titles">
    <div contenteditable="true" spellcheck="false">  
      <p>
        ...
        <p>
            ポータルサイト・フォトサイト・ショップサイトを制作した
        </p>
        <p>
            ログインサイトについては、ログイン・登録機能を実装した。
        </p>
        <p>
            バリデーション機能も実装した。
        </p>
        <p>
            ログインを行うと、ショップサイトにアクセスできる。
        </p>
        <p>
            ショップサイトでは、商品を購入することができる。（一部商品）
        </p>
        <p>
            フォトサイトでは、写真を閲覧することができる。
        </p>
        <p>
            ポータルサイトでは、ショップサイト・フォトサイトにアクセスできる。
        </p>
<!--         
